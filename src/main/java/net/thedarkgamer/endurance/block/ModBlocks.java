...
import net.thedarkgamer.endurance.block.custom.blocktypes.ModPressurePlateBlock;
import net.thedarkgamer.endurance.block.custom.blocktypes.ModSaplingBlock;
import net.thedarkgamer.endurance.block.custom.blocktypes.ModStairsBlock;
import net.thedarkgamer.endurance.block.custom.blocktypes.ModWoodenButtonBlock;
...
public class ModBlocks {
    ...
    public static final Block NETHER_REACTOR_CORE = registerBlock("reactor_core", new Block(FabricBlockSettings.copy(Blocks.IRON_BLOCK)), new FabricItemSettings().rarity(Rarity.EPIC).group(ModItemGroups.BLOCKS));
