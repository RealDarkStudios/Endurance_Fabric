...
import net.thedarkgamer.endurance.util.registry.ModRegistry;
...
public class ModItems {
    ...
    public static final Item AMDIN_FEEDER = registerItem("admin_feeder", new AdminFeederItem(new FabricItemSettings().rarity(Rarity.EPIC)));
