package net.thedarkgamer.endurance.world.features.structure.structures;
...
public class RedwoodHouseStructure extends StructureFeature<DefaultFeatureConfig> {
    public RedwoodHouseStructure(Codec<DefaultFeatureConfig> codec) {
        super(codec);
    }
    ...
    public StructureFeature.StructureStartFactory<DefaultFeatureConfig> getStructureStartFactory() {
        return RedwoodHouseStructure.Start::new;
    }
    ...
    public static class Start extends MarginedStructureStart<DefaultFeatureConfig> {
        ...
        public void init(DynamicRegistryManager dynamicRegistryManager, ChunkGenerator chunkGenerator, StructureManager structureManager, ChunkPos chunkPos, Biome biome, DefaultFeatureConfig defaultFeatureConfig, HeightLimitView heightLimitView) {
            ...
            StructurePoolFeatureConfig structureSettingsAndStartPool = new StructurePoolFeatureConfig(() -> dynamicRegistryManager.get(Registry.STRUCTURE_POOL_KEY)
                    ...
                    .get(new Identifier(EnduranceMod.MOD_ID, "redwood_house/house_pool")),
            ...
            this.children.forEach(piece -> piece.translate(0, 3, 0));
            ...
            EnduranceMod.LOGGER.log(Level.DEBUG, "Redwood House at " +
