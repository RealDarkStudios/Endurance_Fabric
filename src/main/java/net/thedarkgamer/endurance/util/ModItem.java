...
public class ModItem implements ItemConvertible {
    ...
    public ModItem(ModItem.Settings settings) {
        String string;
    ...
    public String toString() {
        return Registry.ITEM.getId(this.asItem()).getPath();
    }

    protected String getOrCreateTranslationKey() {
        if (this.translationKey == null) {
            this.translationKey = Util.createTranslationKey("item", Registry.ITEM.getId(this.asItem()));
        }
    ...
    /**
     * Checks if an item should have its NBT data stored in BLANK sent to the client.
     *
     ...
     * </ul>
     */
    public ModRarity getRarity(ItemStack stack) {
      return this.rarity;
    }
    ...
    public static class Settings {
        ...
        ItemGroup group;
        ModRarity rarity = ModRarity.DEFAULT;
        FoodComponent foodComponent;
        boolean fireproof;

        public ModItem.Settings food(FoodComponent foodComponent) {
            this.foodComponent = foodComponent;
            return this;
        }

        public ModItem.Settings maxCount(int maxCount) {
            if (this.maxDamage > 0) {
        ...
        public ModItem.Settings maxDamageIfAbsent(int maxDamage) {
            return this.maxDamage == 0 ? this.maxDamage(maxDamage) : this;
        }

        public ModItem.Settings maxDamage(int maxDamage) {
            this.maxDamage = maxDamage;
            this.maxCount = 1;
            return this;
        }

        public ModItem.Settings recipeRemainder(Item recipeRemainder) {
            this.recipeRemainder = recipeRemainder;
            return this;
        }

        public ModItem.Settings group(ItemGroup group) {
            this.group = group;
            return this;
        }

        public ModItem.Settings rarity(ModRarity rarity) {
            this.rarity = rarity;
            return this;
        }

        public ModItem.Settings fireproof() {
            this.fireproof = true;
            return this;
        }
    }
